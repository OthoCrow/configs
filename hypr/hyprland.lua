...
hl.on("hyprland.start", function ()
	hl.exec_cmd("gsettings set org.gnome.desktop.interface gtk-theme 'Skeuos-Hyprblue-Dark'")
	hl.exec_cmd("gsettings set org.gnome.desktop.interface color-scheme 'prefer-dark'")

    hl.exec_cmd("wl-clip-persist --clipboard regular")
    hl.exec_cmd("nm-applet & blueman-applet & dunst & flatpak run org.signal.Signal")

    hl.exec_cmd("waybar & hypridle & hyprpaper")
    hl.exec_cmd("snappy-switcher --daemon & elephant & walker --gapplication-service")
...
hl.env("QT_QPA_PLATFORMTHEME","gtk3") -- for QT apps
...
hl.bind("SHIFT + XF86MonBrightnessUp",  hl.dsp.exec_cmd("brightnessctl -e4 -n2 set 1%+"),                  { locked = true, repeating = true })
